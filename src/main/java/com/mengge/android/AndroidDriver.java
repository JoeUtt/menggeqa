...
import static com.mengge.android.AndroidMobileCommandHelper.longPressKeyCodeCommand;
import static com.mengge.android.AndroidMobileCommandHelper.pressKeyCodeCommand;

import com.mengge.*;
import com.mengge.android.internal.JsonToAndroidElementConverter;
import com.mengge.android.*;
import com.mengge.remote.MobilePlatform;
...
public class AndroidDriver<T extends WebElement>
    ...
    @Override public void pressKeyCode(int key, Integer metastate) {
        CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
            .pressKeyCodeCommand(key, metastate));
    }
    ...
    @Override public void longPressKeyCode(int key, Integer metastate) {
        CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
            .longPressKeyCodeCommand(key, metastate));
    }
    ...
    @Override public Connection getConnection() {
        long bitMask = CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
    ...
    @Override public void pushFile(String remotePath, byte[] base64Data) {
        CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
            .pushFileCommandCommand(remotePath, base64Data));
    }
    ...
    @Override public void startActivity(String appPackage, String appActivity,
        ...
        CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
            .startActivityCommand(appPackage, appActivity,
    ...
    public void endTestCoverage(String intent, String path) {
        CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
            .endTestCoverageCommand(intent, path));
    }
    ...
    public String currentActivity() {
        return CommandExecutionHelper.execute(this, AndroidMobileCommandHelper
    ...
    public boolean isLocked() {
        return CommandExecutionHelper.execute(this, AndroidMobileCommandHelper.isLockedCommand());
    }
