...
class DefaultAspect {
    ...
    private static final String EXECUTION_CHANGE_VALUE = "execution(* org.openqa.selenium.WebElement."
        ...
        + "execution(* AndroidElement.replaceValue(..))  || "
        + "execution(* MobileElement.setValue(..))";
    ...
    private static final String AROUND = "execution(* org.openqa.selenium.WebDriver.*(..)) || "
        ...
        + "execution(* FindsByAccessibilityId.*(..)) || "
        + "execution(* FindsByAndroidUIAutomator.*(..)) || "
        + "execution(* FindsByIosUIAutomation.*(..)) || "
        ...
        + "execution(* AndroidElement.*(..)) || "
        + "execution(* IOSElement.*(..)) || "
        + "execution(* AndroidDriver.*(..)) || "
        + "execution(* IOSDriver.*(..)) || "
        + "execution(* AppiumDriver.*(..)) || "
        + "execution(* MobileElement.*(..)) || "
