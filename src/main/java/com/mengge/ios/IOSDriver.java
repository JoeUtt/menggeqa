...
import static com.mengge.ios.IOSMobileCommandHelper.hideKeyboardCommand;

import com.mengge.*;
import com.mengge.android.*;
import com.mengge.ios.internal.JsonToIOSElementConverter;
...
public class IOSDriver<T extends WebElement>
    ...
    implements IOSDeviceActionShortcuts, FindsByIosUIAutomation<T> {
    ...
    @Override public void hideKeyboard(String strategy, String keyName) {
        CommandExecutionHelper.execute(this, IOSMobileCommandHelper
            .hideKeyboardCommand(strategy, keyName));
    }
