    ...
    private static class WaitingFunction implements Function<By, List<WebElement>> {
        ...
        public List<WebElement> apply(By by) {
            ...
            try {
                ...
                isRootCauseInvalidSelector = ThrowableUtil.isInvalidSelectorRootCause(e);
                if (!isRootCauseInvalidSelector) {
                    isRootCauseStaleElementReferenceException = ThrowableUtil
                        .isStaleElementReferenceException(e);
                }

                if (isRootCauseStaleElementReferenceException) {
                    foundStaleElementReferenceException = ThrowableUtil.extractReadableException(e);
                }
