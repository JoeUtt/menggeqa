...
package com.mengge.pagefactory;

import static com.mengge.pagefactory.utils.ProxyFactory.getEnhancedProxy;

import com.mengge.MobileElement;
import com.mengge.TouchableElement;
import com.mengge.android.AndroidDriver;
import com.mengge.android.AndroidElement;
import com.mengge.ios.IOSDriver;
import com.mengge.pagefactory.utils.ProxyFactory;
import com.mengge.pagefactory.bys.ContentType;
import com.mengge.pagefactory.locator.CacheableLocator;
import com.mengge.pagefactory.utils.WebDriverUnpackUtility;
import com.mengge.ios.IOSElement;
...
public class AppiumFieldDecorator implements FieldDecorator {
     ...
     *                {@link Widget} or some other user's
    ...
    public AppiumFieldDecorator(SearchContext context, TimeOutDuration timeOutDuration) {
        ...
        platform = WebDriverUnpackUtility.getPlatform(originalDriver);
        automation = WebDriverUnpackUtility.getAutomation(originalDriver);
    ...
    private Object decorateWidget(Field field) {
        ...
        return ProxyFactory.getEnhancedProxy(widgetType, new Class[] {constructor.getParameterTypes()[0]},
    ...
    private WebElement proxyForAnElement(ElementLocator locator) {
        ...
        return (WebElement) ProxyFactory.getEnhancedProxy(getTypeForProxy(), elementInterceptor);
    }
}
